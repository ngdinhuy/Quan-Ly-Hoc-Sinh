...
class _ThongKeDiMuonScreenState extends State<ThongKeDiMuonScreen> {
  ...
  Future<void> _loadStatistics() async {
    ...
    try {
      ...
      final onTimeRecords =
          await DiemDanhService.getOnTimeByDate(_selectedDate);
      ...
      for (final lop in classesToProcess) {
        ...
        final classOnTimeRecords =
            onTimeRecords.where((r) => r.idLop == lop.id).toList();
        ...
        final absentStudentIds =
            (absenceStats['all_absent_ids'] as List<String>?) ?? [];
        ...
        stats.add(_ClassAttendanceStats(
          ...
          onTimeRecords: classOnTimeRecords,
        ));
      }
